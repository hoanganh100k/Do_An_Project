...
public class OTPverificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileNo.setText("Mã xác minh được gửi đến +84 "+userNo);


        Random random = new Random();
        final int OTP_no=random.nextInt(999999-111111)+111111;
        String SMS_API="https://auth.sms.to/oauth/token"; //https://api.sms.to/sms/send   https://www.fast2sms.com/dev/bulk
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, SMS_API, new Response.Listener<String>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("authorization","Kn5TtQMMGx0BYU3ECctXG6m7l2BKmirq9FZ8YLbi");
